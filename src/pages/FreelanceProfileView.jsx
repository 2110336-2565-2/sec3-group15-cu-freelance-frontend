...
const FreelanceProfileViewPage = ({freelance_id})=>{
    ...
    const addPortHandler = ()=>{
        navigate(`/profile/${AuthCtx.userInfo.userId}/add-portfolio`);
    }
    const chatHandler = ()=>{
        navigate('/home');
    }
        ...
        <>
            <Container>
                ...
                <InformationContainer>
                    ...
                    <Faculty>นิสิต <b>{mapFaculties[freelanceFaculty]}</b> จุฬาฯ</Faculty>
                    <ButtonContainer>
                        {AuthCtx.userInfo.id==freelance_id ? <Button onClick = {addPortHandler} primary width="60%" px='0rem'><b>เพิ่มพอร์ต</b></Button>
                        :<>
                            <Button onClick={sendOrderHandler} primary width='55%'><b>ส่งออเดอร์</b></Button>
                            <Button onClick={chatHandler} secondary width='35%'><b>แชท</b></Button>
                        </>}
                    </ButtonContainer>
                </InformationContainer>
            </Container>
...
const mapFaculties = {
    ...
    "Sasin Graduate Institute of Business Administion": "สถาบันบัณฑิตบริหารธุรกิจ ศศินทร์ฯ",
