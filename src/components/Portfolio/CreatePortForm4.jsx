...
const CreatePortForm4 = ({
	...
	const upload = (portfolioId, img) => {
		const data = new FormData();
		data.append("file", img);
		return new Promise((resolve, reject) => {
			apiClient
				.put(`/file/portfolio/${portfolioId}`, data)
				.then((res) => {
					resolve(res.data);
				})
				.catch((err) => {
	...
	return (
		<>
			<LoadingModal
				...
				desc={
					"เรากำลังอัพโหลดพอร์โฟลิโอคุณเข้าสู่ระบบกรุณารอสักครู่..."
				}
			/>
