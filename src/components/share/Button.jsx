...
const Button = (props) => {
  ...
  const ButtonPrimary = tw.button`text-white bg-[#D62B70] rounded-lg text-mobile-h2 dt:text-xl px-6 py-3 font-normal`;
  const ButtonSecondary = tw.button`text-black  text-mobile-h2 dt:text-xl text-center px-6 py-3 font-normal`;
