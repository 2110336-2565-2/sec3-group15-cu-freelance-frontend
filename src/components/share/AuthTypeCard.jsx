...
const Container = styled.div(()=>[
    tw`flex box-border rounded-[20px] border-4 border-black w-full ip8:w-[250px] dt:max-w-full dt:w-2/5 flex-row 
    dt:flex-col shadow-inherit dt:relative dt:h-[450px] items-center justify-between px-4`
]);
const Type = styled.div(()=>[
    tw`font-ibm font-bold text-mobile-h2 dt:text-desktop-h2 dt:text-center my-4`
])
