...
const ModalOverlay = (props) => {
  const content = (
    <div tw="font-ibm fixed m-auto w-full h-full dt:max-w-[600px] dt:max-h-[800px] rounded-none py-2 px-3 top-0 bottom-0 left-0 right-0 bg-white z-[70] dt:rounded-[20px]">
      <FirstRow>
        {props.header}
