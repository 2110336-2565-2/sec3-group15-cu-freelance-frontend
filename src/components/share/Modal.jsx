...
const ModalOverlay = (props) => {
  const content = (
    <div tw="fixed m-auto w-[400px] min-h-[350px] py-8 top-0 bottom-0 left-0 right-0 z-[60] h-[35vh] rounded-2xl bg-white flex flex-col items-center justify-between">
