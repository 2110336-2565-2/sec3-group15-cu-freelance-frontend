...
const styles = {
  content: () => [tw`flex flex-col w-[83.2%] h-[86.3%] items-center m-auto`],
  comment: () => [tw`text-left w-[100%] h-[45%] font-ibm text-xl`],
  commentor: () => [
    tw`flex flex-col items-center justify-end w-[100%] h-[55%]`,
  ],
  image: () => [tw`w-[35%]`],
  name: () => [tw`text-[20px] text-[#D62B70] font-bold font-ibm`],
  position: () => [tw`font-inter`],
};
