                ...
                <div tw="flex flex-col  dt:flex-row justify-center items-center">
                    ...
                    <div tw="flex flex-col">
                        ...
                        <motion.h1 variants={fadeIn('up', 0.1)} initial='hidden' whileInView={'show'}
                            viewport={{once:false, amount:0.7}} tw="font-ibm font-medium text-2xl dt:text-5xl "
                        ...
                        <motion.p variants={fadeIn('up', 0.1)} initial='hidden' whileInView={'show'}
                            viewport={{once:false, amount:0.7}} tw="mt-2 font-ibm text-lg dt:text-xl max-w-[600px]">
