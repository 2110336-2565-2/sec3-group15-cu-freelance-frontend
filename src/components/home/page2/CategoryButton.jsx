...
const Button = styled.button(({ isSelect }) => [
  tw`font-ibm dt:text-desktop-h2 px-10 py-1 rounded-[27px] flex gap-x-5 items-center transition-all duration-500 ease-linear`,
...
const Text = styled.div(({ isSelect }) => [
  isSelect && tw`inline dt:inline`,
  !isSelect && tw`hidden dt:inline`,
]);
